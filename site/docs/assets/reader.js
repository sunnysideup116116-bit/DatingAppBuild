const documents = [
  ...
  { file: "05.1-public-ayue.md", number: "05.1", label: "公開阿月：主聊天室與 Agent 回合", group: "PRODUCT & DOMAIN" },
  { file: "05.2-private-ayue.md", number: "05.2", label: "阿月悄悄話：Private Mediator", group: "PRODUCT & DOMAIN" },
  { file: "05.3-pi-agent-architecture.md", number: "05.3", label: "Pi Agent 架構", group: "PRODUCT & DOMAIN" },
  { file: "06-matchmaking.md", number: "06", label: "配對與關係建立", group: "PRODUCT & DOMAIN" },
  { file: "06.1-matchmaking-ayue.md", number: "06.1", label: "配對阿月：從聊天提問到牽線決策", group: "PRODUCT & DOMAIN" },
  { file: "07-chat-risk.md", number: "07", label: "聊天與風險治理", group: "PRODUCT & DOMAIN" },
  { file: "07.1-chat-risk.md", number: "07.1", label: "聊天風險：從送出訊息到安全介入", group: "PRODUCT & DOMAIN" },
  { file: "08-voice.md", number: "08", label: "語音互動", group: "PRODUCT & DOMAIN" },
  { file: "08.1-voice-ayue.md", number: "08.1", label: "語音阿月：能力協商、即時 Session 與任務操作", group: "PRODUCT & DOMAIN" },
